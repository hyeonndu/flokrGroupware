  ...
  <main class="notice-container">
    <div class="notice-header">
      <div class="notice-title">
        <h1>공지사항 등록</h1>
        <p>중요한 공지사항을 작성하여 전체 직원에게 공유하세요.</p>
      </div>
    </div>
    ...
    <form id="noticeForm" action="${pageContext.request.contextPath}/noticeInsert" method="post">
      ...
      <div class="notice-form">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="noticeTitle" name="noticeTitle" placeholder="공지사항 제목을 입력하세요" required>
        </div>
        ...
        <div class="form-group">
          <div class="form-check">
            <input type="checkbox" class="form-check-input" id="isMandatory" name="isMandatory" value="1">
        ...
        <div class="form-group">
          ...
          <textarea class="form-control" id="noticeContent" name="noticeContent" placeholder="공지사항 내용을 입력하세요" required></textarea>
        </div>
        
        <!-- 알림 발송 여부 -->
        <div class="form-group">
          <div class="form-check">
            <input type="checkbox" class="form-check-input" id="sendNotification" name="sendNotification" value="true" checked>
            <label for="sendNotification" class="form-check-label">전체 직원에게 알림 발송</label>
          </div>
          <p class="form-text">체크하면 공지사항 등록 시 모든 직원에게 알림이 전송됩니다.</p>
        </div>
      </div>

...
<head>
    ...
    <style>
		...
		.fc-daygrid-event-harness {
		    ...
		    border-left: none !important; /* 강제로 왼쪽 테두리 제거 */
		}
       ...
       /* 월/연도 선택기 스타일 */
        ...
        .date-schedule-importance.normal {
            background-color: #10b981;
        }
        
        .date-schedule-importance.low {
        ...
        .date-schedule-type-badge.other {
